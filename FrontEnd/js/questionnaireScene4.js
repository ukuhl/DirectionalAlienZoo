...
class QuestionnaireScene4 extends Phaser.Scene {
	...
	create() {
		...
		// different question for no explanation control and other groups:
		...
		var item10 = [
			"10. I received the feedback on what choice would have led to a different result in a timely and efficient manner."
		];
		}
