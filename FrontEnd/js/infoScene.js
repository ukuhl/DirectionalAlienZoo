import GetProlificID from './getProlificID.js';
...
class InfoScene extends Phaser.Scene {
	...
	onClickBtnAgree() {
		if(this.isBrowserWindowMaximized() == false) {
			...
			var getProlificID = new GetProlificID(this.varObj);
			this.scene.add('getProlificID', getProlificID);
			this.scene.start('getProlificID');
		}
	}
