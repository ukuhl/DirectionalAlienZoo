...
class StartScene extends Phaser.Scene {
	...
	create() {
		...
		// instructions vary according to group:
		...
		if(this.varObj.api.expGroup == "0") {
			var textBlock6 = [
				"After " + this.varObj.numTrialsPerBlock + " rounds, you will get a summary of your past choices.",
				"",
			];
		} else if(this.varObj.api.expGroup == "1"){
			var textBlock6 = [
				"After " + this.varObj.numTrialsPerBlock + " rounds, you will get a summary of your past choices.",
				"Also, there will be feedback on what choice would have led to a BETTER result.",
			];
		} else if(this.varObj.api.expGroup == "2"){
			var textBlock6 = [
				"After " + this.varObj.numTrialsPerBlock + " rounds, you will get a summary of your past choices.",
				"Also, there will be feedback on what choice would have led to a WORSE result.",
			];
		} else if(this.varObj.api.expGroup == "3"){
			var textBlock6 = [
				"After " + this.varObj.numTrialsPerBlock + " rounds, you will get a summary of your past choices.",
				"Also, there will be feedback on what choices would have led to a BETTER or WORSE results.",
			];
...
//}
		...
		this.add.text(window.innerWidth * 0.025, window.innerHeight * 0.725, textBlock6, { fontFamily: "Arial", fontSize: '18px', fontStyle: "bold italic", color: '#000000', align: 'left', lineSpacing: 10});

		this.add.text(window.innerWidth * 0.025, window.innerHeight * 0.825, textBlock7, { fontFamily: "Arial", fontSize: '18px', color: '#000000', align: 'left', lineSpacing: 10});
